...
; we have to preserve C flag in this routine

;SM: hacked this routine to check for SWR switching
	; TODO: check if _byte_hi = &C0
	; reset to &80 and switch to next SWR bank

	; bit 6 is set when we go from &BFFF to &C000
	; use bit to put bit 6 into V flag
	bit _byte_hi
	bvc no_change
